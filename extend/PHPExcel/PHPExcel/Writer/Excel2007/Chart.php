...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    private function writeValueAxis($objWriter, PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
    {
        ...
        if (! is_null($majorGridlines->getLineColorProperty('value'))) {
            ...
            if (! is_null($majorGridlines->getLineStyleProperty(array(
                'arrow',
                'head',
                'type'
            )))) {
        ...
        if (! is_null($majorGridlines->getShadowProperty('presets'))) {
            ...
            if (! is_null($majorGridlines->getShadowProperty(array(
                'size',
                'sx'
            )))) {
                $objWriter->writeAttribute('sx', $majorGridlines->getShadowProperty(array(
                    'size',
                    'sx'
                )));
            }
            if (! is_null($majorGridlines->getShadowProperty(array(
                ...
                $objWriter->writeAttribute('sy', $majorGridlines->getShadowProperty(array(
                    'size',
                    'sy'
                )));
            }
            if (! is_null($majorGridlines->getShadowProperty(array(
                ...
                $objWriter->writeAttribute('kx', $majorGridlines->getShadowProperty(array(
                    'size',
                    'kx'
                )));
            }
            ...
            $objWriter->writeAttribute('val', $majorGridlines->getShadowProperty(array(
                'color',
                'value'
            )));
        ...
        if ($minorGridlines->getObjectState()) {
            ...
            if (! is_null($minorGridlines->getLineColorProperty('value'))) {
                ...
                if (! is_null($minorGridlines->getLineStyleProperty(array(
                    'arrow',
                    'head',
                    'type'
                )))) {
                    $objWriter->startElement('a:headEnd');
                    $objWriter->writeAttribute('type', $minorGridlines->getLineStyleProperty(array(
                        'arrow',
                        'head',
                        'type'
                    )));
            ...
            if (! is_null($minorGridlines->getShadowProperty('presets'))) {
                ...
                if (! is_null($minorGridlines->getShadowProperty(array(
                    'size',
                    'sx'
                )))) {
                    $objWriter->writeAttribute('sx', $minorGridlines->getShadowProperty(array(
                        'size',
                        'sx'
                    )));
                }
                if (! is_null($minorGridlines->getShadowProperty(array(
                    ...
                    $objWriter->writeAttribute('sy', $minorGridlines->getShadowProperty(array(
                        'size',
                        'sy'
                    )));
                }
                if (! is_null($minorGridlines->getShadowProperty(array(
                    ...
                    $objWriter->writeAttribute('kx', $minorGridlines->getShadowProperty(array(
                        'size',
                        'kx'
                    )));
                }
                ...
                $objWriter->writeAttribute('val', $minorGridlines->getShadowProperty(array(
                    'color',
                    'value'
                )));
                $objWriter->startElement('a:alpha');
        ...
        if (! is_null($xAxis->getLineStyleProperty(array(
            'arrow',
            'head',
            'type'
        )))) {
            $objWriter->startElement('a:headEnd');
            $objWriter->writeAttribute('type', $xAxis->getLineStyleProperty(array(
                'arrow',
                'head',
                'type'
            )));
        ...
        if (! is_null($xAxis->getGlowProperty('size'))) {
            ...
            $objWriter->writeAttribute('val', $xAxis->getGlowProperty(array(
                'color',
                'value'
            )));
            $objWriter->startElement('a:alpha');
        ...
        if (! is_null($xAxis->getShadowProperty('presets'))) {
            ...
            if (! is_null($xAxis->getShadowProperty(array(
                'size',
                'sx'
            )))) {
                $objWriter->writeAttribute('sx', $xAxis->getShadowProperty(array(
                    'size',
                    'sx'
                )));
            }
            if (! is_null($xAxis->getShadowProperty(array(
                ...
                $objWriter->writeAttribute('sy', $xAxis->getShadowProperty(array(
                    'size',
                    'sy'
                )));
            }
            if (! is_null($xAxis->getShadowProperty(array(
                ...
                $objWriter->writeAttribute('kx', $xAxis->getShadowProperty(array(
                    'size',
                    'kx'
                )));
            }
            ...
            $objWriter->writeAttribute('val', $xAxis->getShadowProperty(array(
                'color',
                'value'
            )));
            $objWriter->startElement('a:alpha');
