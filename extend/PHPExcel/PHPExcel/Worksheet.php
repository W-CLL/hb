...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    public function addChart(PHPExcel_Chart $pChart = null, $iChartIndex = null)
    {
        ...
        if (is_null($iChartIndex)) {
            ...
            array_splice($this->chartCollection, $iChartIndex, 0, array(
                $pChart
            ));
        }
            ...
            foreach ($this->getCellCollection(false) as $cellID) {
                ...
                if ($cell !== null && isset($autoSizes[$this->cellCollection->getCurrentColumn()])) {
                    ...
                    if (! isset($isMergeCell[$this->cellCollection->getCurrentAddress()])) {
                        ...
                        $autoSizes[$this->cellCollection->getCurrentColumn()] = max((float) $autoSizes[$this->cellCollection->getCurrentColumn()], (float) PHPExcel_Shared_Font::calculateColumnWidth($this->getParent()
                            ->getCellXfByIndex($cell->getXfIndex())
