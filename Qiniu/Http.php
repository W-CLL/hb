...
class Http
{
    ...
    public function sendRequest(Request $request)
    {
        ...
        if ($errorCode) {
            $body = sprintf('{"code":"%s", "error":"%s"}', $errorCode, $errorMessage);
        } else {
            $body = $result;
        }
    ...
    protected function buildMultipartForm($fields, $files)
    {
        ...
        foreach ($fields as $name => $value) {
            ...
            array_push($data, sprintf('Content-Disposition: form-data; name="%s"', $name));
            array_push($data, '');
        ...
        foreach ($files as $file) {
            ...
            array_push($data, sprintf('Content-Disposition: form-data; name="%s"; filename="%s"', $name, $fileName));
