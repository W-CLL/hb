...
class Auth{
  ...
  protected $_config = array(
    ...
    'auth_group_access' => 'user_type', // 用户-用户组关系表
    'auth_rule'     => 'auth_rule',     // 权限规则表
    'auth_user'     => 'user_info'       // 用户信息表
  );
  ...
  public function getGroups($uid) {
    ...
    $user_groups = \think\Db::name($this->_config['auth_group_access'])
      ...
      ->where("a.Type_Id='$uid' and g.status='1'")
      ->field('a.Type_Id uid,Group_Id groud_id,title,rules')->select();
