<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpstudy_pro\WWW\public/../application/login\view\login\login.html";i:1602659360;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" media="screen" href="/public/static/login/style.css">
	<link rel="stylesheet" type="text/css" href="/public/static/login/reset.css">
...
<body>
	...
	<!-- scripts -->
	<script src="/public/static/login/particles.min.js"></script>
	<script src="/public/static/login/app.js"></script>
	<!-- 动态背景 -->
	...
	<script>
		...
		form.on('submit(lay-submit-login)', function (data) {
			if (slider.isOk()) {
				...
				$.post("/public/index.php/checklogin", data.field, function (data) {
				
					layer.msg(data.msg, function () {
						if (data.code == 1) {
							window.location.href = "/public/index.php/index";
						}
					});
				}, 'json');
			}
