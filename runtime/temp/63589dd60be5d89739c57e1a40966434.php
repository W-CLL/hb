<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\public/../application/project\view\project\upd_project.html";i:1602815663;s:20:"./static/header.html";i:1602579388;}*/ ?>
    <head>
...
<body>
  <form class="layui-form" action="">
    <input type="hidden" class="layui-input" value="<?php echo $list['Id']; ?>" name="Id">
    <div class="layui-form-item">
      <div class="layui-inline">
        <label class="layui-form-label">客户:</label>
        <div class="layui-input-inline">
          <select name="client_id" lay-verify="required" lay-search="" lay-filter="select">
            <option value="<?php echo $list['Client_Id']; ?>"><?php echo $list['Client']; ?></option>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <select name="projectgrade" lay-filter="select">
          <option value="<?php echo $list['ProjectGrade']; ?>"><?php echo $list['ProjectGrade']; ?></option>
    ...
    <div class="layui-form-item">
      <div class="layui-inline ">
        ...
        <div class="layui-input-inline" id="seeuser">
          ...
          <?php else: if(is_array($list['see_user']) || $list['see_user'] instanceof \think\Collection || $list['see_user'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['see_user'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <select name="see_user_id[]" lay-verify="required" lay-search="" class="seeuser" lay-filter="select">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="projectname" value="<?php echo $list['ProjectName']; ?>" lay-verify="required" placeholder="请输入项目名"
      ...
      <div class="layui-inline">
        ...
        <div class="layui-input-inline">
          <input type="text" class="layui-input" id="test9" placeholder=" - " name="time" lay-verify="required"
            value="<?php echo $list['ExtensionStart']; ?> - <?php echo $list['ExtensionEnd']; ?>">
        </div>
      </div>
    </div>
    <div class="layui-form-item">
      <div class="layui-inline ">
        ...
        <div class="layui-input-inline" id="promotion">
          <?php if(is_array($list['pro_user']) || $list['pro_user'] instanceof \think\Collection || $list['pro_user'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['pro_user'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <select name="pro_user_id[]" lay-verify="required" lay-search="" class="promotion" lay-filter="select">
            <option value="<?php echo $vo['Id']; ?>"><?php echo $vo['Pro_User']; ?></option>
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-inline" id="user_53">
          <?php if(is_array($list['user_53']) || $list['user_53'] instanceof \think\Collection || $list['user_53'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['user_53'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <select name="user_53_id[]" lay-verify="required" lay-search="" class="user_53" lay-filter="select">
            <option value="<?php echo $vo['Id']; ?>"><?php echo $vo['User_53']; ?></option>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="code_53" value="<?php echo $list['Code_53']; ?>" lay-verify="required" placeholder="请输入项目53代码"
          autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="estimatedcost" value="<?php echo $list['EstimatedCost']; ?>" lay-verify="required|number"
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="targetnumber" value="<?php echo $list['TargetNumber']; ?>" lay-verify="required|number"
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="customerbudget" value="<?php echo $list['CustomerBudget']; ?>" lay-verify="required|number"
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="brand" value="<?php echo $list['Brand']; ?> "lay-verify="" placeholder="请输入品牌" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="address" value="<?php echo $list['Address']; ?>" lay-verify="" placeholder="请输入地域" autocomplete="off"
          class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="remarks" value="<?php echo $list['Remarks']; ?>" lay-verify="" placeholder="请输入备注" autocomplete="off"
          class="layui-input">
      </div>
    </div>
